/**
 * @fileoverview defaultRolesAndPermissions - Seed de roles y permisos base (RBAC)
 * @description Crea los roles base del sistema, los permisos existentes y las asignaciones
 *              rol-permiso, además de migrar el rol enum actual de cada usuario hacia
 *              asignaciones múltiples en la tabla `user_roles`.
 */
...
// Asignación de permisos por rol (simple, sin herencia)
...
/**
 * Asigna permisos a roles según el mapeo definido.
 */
...
/**
 * Migra el rol enum actual del usuario a la tabla user_roles.
 */
...
/**
 * Ejecuta el seed completo: roles, permisos, asignaciones rol-permiso y migración de usuarios.
 */
export async function seedDefaultRolesAndPermissions(): Promise<void> {
  console.log("[Seed] Iniciando seed de roles y permisos (RBAC)...");
  ...
  console.log("[Seed] Seed de roles y permisos completado.");
}
