...
import { CameraFailureQueryParams } from '../../domain/interfaces/ICameraStartFailureRepository';
...
export class GetCameraFailuresApplicationService {
   ...
   */
  async getCameraFailures(params?: CameraFailureQueryParams): Promise<{ failures: any[]; total: number }> {
