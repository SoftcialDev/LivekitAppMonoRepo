 ...
 */
export interface TalkActiveBannerProps {
  /**
 ...
 */
export const TalkActiveBanner: React.FC<TalkActiveBannerProps> = ({ isActive, isIncoming, justEnded, supervisorName }) => {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 bg-[var(--color-secondary)] text-[var(--color-primary-dark)] px-6 py-3 z-50 flex items-center justify-center gap-4 shadow-lg">
      {!justEnded && (
