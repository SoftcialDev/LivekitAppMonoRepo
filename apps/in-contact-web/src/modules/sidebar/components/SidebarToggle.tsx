/**
 * @fileoverview SidebarToggle component
 * @summary Toggle button for collapsing/expanding sidebar
 * @description Always-visible toggle icon to collapse or expand the sidebar
 */

import React from 'react';
import type { ISidebarToggleProps } from './types/sidebarComponentsTypes';
 ...
 * ```
 */
export const SidebarToggle: React.FC<ISidebarToggleProps> = ({
  isCollapsed,
  onToggle,
}) => (
  <button
