/**
 * @fileoverview TrashIcon - Icon component for delete/trash action
 * @summary SVG icon for trash/delete buttons
 * @description Reusable icon component for delete functionality.
 ...
 * TrashIcon component
 * 
 * SVG icon representing a trash/delete action.
 ...
 */
export const TrashIcon: React.FC<IIconProps> = ({ className = '', size = '1.5rem' }) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
